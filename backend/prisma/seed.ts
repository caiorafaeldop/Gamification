...
async function main() {
  ...
  await prisma.achievement.createMany({
    data: [
      { name: 'First Steps', description: 'Complete your first task.', points: 50, icon: '🌟', color: '#Gold', criteria: 'task_count >= 1' },
      { name: 'Bug Hunter', description: 'Find and fix a bug.', points: 100, icon: '🐛', color: '#Red', criteria: 'bug_fixed >= 1' },
      { name: 'Team Player', description: 'Join a project.', points: 200, icon: '🤝', color: '#Blue', criteria: 'project_joined >= 1' },
    ],
  });
