                ...
                <header className="h-16 flex items-center justify-between px-4 sm:px-6 bg-surface-light/80 dark:bg-surface-dark/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-800 sticky top-0 z-30">
                    ...
                    <div className="flex items-center gap-3">
                        <a
                            ...
                            className="flex shrink-0 items-center gap-2 rounded-full bg-[#5865F2] px-4 py-2 text-[11px] font-bold text-white shadow-lg shadow-[#5865F2]/20 transition-all hover:scale-105 hover:bg-[#4752C4] active:scale-95 group"
                        >
