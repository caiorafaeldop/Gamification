...
const LoginScreen = () => {
  ...
  return (
    <div className="bg-background-light dark:bg-background-dark text-slate-800 dark:text-gray-100 font-sans transition-colors duration-300 min-h-screen flex flex-col md:flex-row">
      {/* Decorative Side */}
      <div className="hidden md:flex md:w-1/2 lg:w-5/12 relative overflow-hidden">
        <img src={loginScreenLeft} alt="Login" className="absolute inset-0 w-full h-full object-cover" />
      </div>
