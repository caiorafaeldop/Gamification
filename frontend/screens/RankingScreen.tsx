...
import { PageHero, SurfaceCard, EmptyState } from '../components/ui';
...
const RankingScreen = () => {
  ...
  return (
    <div className="mx-auto max-w-[1480px] space-y-8 p-4 sm:p-6 lg:p-8">
      <PageHero
        icon={Trophy}
        tagLabel={selectedProjectIds.length > 0 ? 'Ranking filtrado por projeto' : 'Arena de Performance'}
        title={selectedProjectIds.length > 0 ? 'Ranking por Projeto' : 'Ranking Global'}
        description="Consolide sua jornada e compare-se com a elite. Sua posição reflete dedicação, colaboração e conquistas."
