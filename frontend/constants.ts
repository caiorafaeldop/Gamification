...
export const ACHIEVEMENTS: Achievement[] = [
  { id: '1', name: 'Bem-vindo a bordo', description: 'Complete seu cadastro inicial.', icon: 'Rocket', points: 100, criteria: 'cadastro' }, // Added points/criteria to match typical interface if strict? Check interface again.
