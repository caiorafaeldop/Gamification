...
export const COLUMN_COLORS = {
    ...
    BLUE:    { name: 'Azul',   bg: 'bg-blue-200/80 dark:bg-blue-900/40',     border: 'border-blue-200 dark:border-blue-800/30',    text: 'text-blue-700 dark:text-blue-300', badge: 'bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400', decoration: 'border-t-4 border-t-blue-500' },
